...
class BaseDetailCollectionForm(forms.Form):
    ...
    additional_product_price = forms.DecimalField(required=False, initial=0)
    number_of_users = forms.IntegerField(required=True)
    sponsor_bonus = forms.DecimalField(required=False, initial=0)
...
class BinaryForm(BaseDetailCollectionForm):
    binary_bonus = forms.DecimalField(required=False, initial=0)
    ...
    capping_amount = forms.DecimalField(required=False, initial=0)
