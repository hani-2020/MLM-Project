...
class BaseDetailCollectionForm(forms.Form):
    ...
    sponsor_bonus_as_amount = forms.BooleanField(required=False, initial=False)
    ...
    matching_bonus_as_amount = forms.BooleanField(required=False, initial=False)
...
class BinaryForm(BaseDetailCollectionForm):
    ...
    binary_bonus_as_amount = forms.BooleanField(required=False, initial=False)
...
class UnilevelForm(BaseDetailCollectionForm):
    ...
    level_bonus_as_amount = forms.BooleanField(required=False, initial=False)